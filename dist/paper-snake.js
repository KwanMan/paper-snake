...
var RoughGeneratorAsync = function (_RoughGenerator) {
    ...
    createClass(RoughGeneratorAsync, [{
        ...
        // @ts-ignore
        value: function () {
            var _ref = asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(x1, y1, x2, y2, options) {
                var o;
        ...
        key: 'rectangle',
        value: function () {
            var _ref2 = asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(x, y, width, height, options) {
                var o, paths, points;
        ...
        key: 'circle',
        value: function () {
            var _ref4 = asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(x, y, diameter, options) {
                var ret;
        ...
        key: 'linearPath',
        value: function () {
            var _ref5 = asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5(points, options) {
                var o;
        ...
        key: 'arc',
        value: function () {
            var _ref6 = asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee6(x, y, width, height, start, stop) {
                var closed = arguments.length > 6 && arguments[6] !== undefined ? arguments[6] : false;
                var options = arguments[7];
                var o, paths, shape;
        ...
        key: 'polygon',
        value: function () {
            var _ref8 = asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee8(points, options) {
        ...
        key: 'path',
        value: function () {
            var _ref9 = asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee9(d, options) {
...
var RoughCanvasAsync = function (_RoughCanvas) {
    ...
    createClass(RoughCanvasAsync, [{
        ...
        key: 'arc',
        value: function () {
            var _ref7 = asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee7(x, y, width, height, start, stop) {
                var closed = arguments.length > 6 && arguments[6] !== undefined ? arguments[6] : false;
                var options = arguments[7];
                var d;
                return regeneratorRuntime.wrap(function _callee7$(_context7) {
...
function createSnake() {
  ...
  function getState() {
    return {
      occupied: occupied,
      coordinates: [].concat(toConsumableArray(leftWall.getCoordinates()), toConsumableArray(rightWall.getCoordinatesReverse()))
    };
  }
